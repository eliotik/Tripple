...
public class Element {
	...
	public void render(Graphics g, int x, int y, int width, int height, boolean animate, boolean showBorder) {
	...
	public static void renderBorder(Graphics g, int x, int y, int width, int height, boolean animate) {
		...
		g.drawImage(Tiles.getTilesAssets(), 
				...
				border_tile_y_width + border_tile_y_border_pixelized + tile_border_width_pixelized - 1,
